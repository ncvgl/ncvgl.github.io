...
<img src="/assets/images/slawk-qa-browser.png" alt="QA agent testing Slawk in Chrome alongside the real Slack workspace" style="max-width: 100%; height: auto; display: block; margin: 20px 0;">
...
After the QA agent found 14 bugs, I asked the CTO to fix them all in parallel. It ran them 3 at a time using subagents. Three hours total.
